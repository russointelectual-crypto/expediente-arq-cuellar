 ...
 *
 * Versión BASE, sin patrones: guarda sus datos y hace respetar el flujo de estados
 * con una tabla de transiciones (lo que quedó del H2). Todo lo demás
 * (avisos, cobro, impresión, persistencia) vive fuera de esta clase.
 */
